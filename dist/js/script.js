...
//dark mode
const tombol_dark = document.querySelector("header nav ul a li button");
const tag_html = document.querySelector("html");

tombol_dark.addEventListener("click", function () {
  tag_html.classList.toggle("dark");
});
